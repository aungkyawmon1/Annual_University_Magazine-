        ...
        <div class="row mt-4 d-flex flex-row">
            <div class="d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                      <a class="nav-link activeWhite" href="#">Manager</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row mt-4">
            <div class="col-4 mb-4">
                <div class="mt-5">
                    ...
                    <input type="text" class="form-control" id="article-caption" placeholder="Username or ID">
                </div>
                <div class="mt-3">
                    <label for="article-caption" class="form-label">Password</label>
                    <input type="password" class="form-control" id="article-caption" placeholder="Password">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input type="email" class="form-control" id="article-caption" placeholder="Email">
                </div>
            </div>
            <div class="col-4">
                <div class="mt-5">
                    <label for="article-caption" class="form-label">Phone</label>
                    <input type="text" class="form-control" id="article-caption" placeholder="Phone">
                </div>
                <div class="mt-3">
                    <label for="article-caption" class="form-label">Address</label>
                    <input type="password" class="form-control" id="article-caption" placeholder="Address">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input type="datetime-local" class="form-control" id="article-caption" placeholder="DoB">
                </div>
                <div class="mt-3">
